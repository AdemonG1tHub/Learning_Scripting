...
def checkout():
    _ = os.system('cls')
    print(f"Here is what we have to offer:\n1. {item1}\n2. {item2}\n3. {item3}\n3. {item4}")
    answer = input("\nIf you'd like to order any of these, type the number of the first item you'd like to purchase, however if you want to complete your purchases then enter FINSH: ")
    if answer == "1":
        ...
        checkout.append("\nYou added {item2} to your basket and costs {item2Price}")
        checkout()
    elif answer == "3":
